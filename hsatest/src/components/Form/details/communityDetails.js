...
class CommunityDetails extends React.Component{
    ...
    updateDB = () => {
        ...
        tempDB.push( new FNAddress('Birch Narrows First Nation','403','Sasketchewan','GENERAL DELIVERY','TURNOR LAKE','Sasketchewan','S0M 3E0'));
        tempDB.push( new FNAddress('Black Lake','359','Sasketchewan','PO BOX 27','BLACK LAKE','Sasketchewan','S0J 0H0'));
        tempDB.push( new FNAddress('Buffalo River Dene Nation','398','Sasketchewan','GENERAL DELIVERY','DILLON','Sasketchewan','S0M 0S0'));
        tempDB.push( new FNAddress('Canoe Lake Cree First Nation','394','Sasketchewan','GENERAL DELIVERY','CANOE NARROWS','Sasketchewan','S0M 0K0'));
        tempDB.push( new FNAddress('Carry The Kettle','378','Sasketchewan','PO BOX 57','SINTALUTA','Sasketchewan','S0G 4N0'));
        tempDB.push( new FNAddress('Clearwater River Dene','401','Sasketchewan','PO BOX 5050','CLEARWATER RIVER','Sasketchewan','S0M 3H0'));
        tempDB.push( new FNAddress('Cote First Nation 366','366','Sasketchewan','PO BOX 1659','KAMSACK','Sasketchewan','S0A 1S0'));
        tempDB.push( new FNAddress('Little Pine','340','Sasketchewan','PO BOX 70','PAYNTON','Sasketchewan','S0M 2J0'));
        tempDB.push( new FNAddress('Lucky Man','341','Sasketchewan','103B PACKHAM AVENUE','SASKATOON','Sasketchewan','S7N 4K4'));
        tempDB.push( new FNAddress('Makwa Sahgaiehcan First Nation','396','Sasketchewan','PO BOX 340','LOON LAKE','Sasketchewan','S0M 1L0'));
        tempDB.push( new FNAddress('Ministikwan Lake Cree Nation','397','Sasketchewan','PO BOX 240','ISLAND LAKE','Sasketchewan','S0M 3G0'));
        tempDB.push( new FNAddress('Pasqua First Nation #79','383','Sasketchewan','PO BOX 79','PASQUA','Sasketchewan','S0G 5M0'));
        tempDB.push( new FNAddress('Peepeekisis Cree Nation No.81','384','Sasketchewan','PO BOX 518','BALCARRES','Sasketchewan','S0G 0C0'));
        tempDB.push( new FNAddress('Pelican Lake','405','Sasketchewan','PO BOX 399','LEOVILLE','Sasketchewan','S0J 1N0'));
        tempDB.push( new FNAddress('Peter Ballantyne Cree Nation','355','Sasketchewan','GENERAL DELIVERY','PELICAN NARROWS','Sasketchewan','S0P 0E0'));
        tempDB.push( new FNAddress('Pheasant Rump Nakota','409','Sasketchewan','PO BOX 238','KISBEY','Sasketchewan','S0C 1L0'));
        tempDB.push( new FNAddress('Piapot','385','Sasketchewan','GENERAL DELIVERY','ZEHNER','Sasketchewan','S0G 5K0'));
        tempDB.push( new FNAddress('Zagime Anishinabek','364','Sasketchewan','PO BOX 339','GRENFELL','Sasketchewan','S0G 2B0'));
        ...
        tempDB.push( new FNAddress('Ahtahkakoop','406','Sasketchewan','PO BOX 220','SHELL LAKE','Sasketchewan','S0J 2G0'));
        tempDB.push( new FNAddress('Beardy s and Okemasis','369','Sasketchewan','PO BOX 340','DUCK LAKE','Sasketchewan','S0K 1J0'));
        tempDB.push( new FNAddress('Big Island Lake Cree Nation','399','Sasketchewan','PO BOX 309','PIERCELAND','Sasketchewan','S0M 2K0'));
        tempDB.push( new FNAddress('Big River','404','Sasketchewan','PO BOX 519','DEBDEN','Sasketchewan','S0J 0S0'));
        tempDB.push( new FNAddress('Cowessess','361','Sasketchewan','PO BOX 100','COWESSESS','Sasketchewan','S0G 5L0'));
        tempDB.push( new FNAddress('Cumberland House Cree Nation','350','Sasketchewan','PO BOX 220','CUMBERLAND HOUSE','Sasketchewan','S0E 0S0'));
        tempDB.push( new FNAddress('Day Star','389','Sasketchewan','PO BOX 277','PUNNICHY','Sasketchewan','S0A 3C0'));
        tempDB.push( new FNAddress('English River First Nation','400','Sasketchewan','GENERAL DELIVERY','PATUANAK','Sasketchewan','S0M 2H0'));
        tempDB.push( new FNAddress('Fishing Lake First Nation','390','Sasketchewan','PO BOX 508','WADENA','Sasketchewan','S0A 4J0'));
        tempDB.push( new FNAddress('Flying Dust First Nation','395','Sasketchewan','8001 FLYING DUST RESERVE','MEADOW LAKE','Sasketchewan','S9X 1T8'));
        tempDB.push( new FNAddress('Fond du Lac','351','Sasketchewan','PO BOX 211','FOND DU LAC','Sasketchewan','S0J 0W0'));
        tempDB.push( new FNAddress('George Gordon First Nation','391','Sasketchewan','PO BOX 248','PUNNICHY','Sasketchewan','S0A 3C0'));
        tempDB.push( new FNAddress('Hatchet Lake','352','Sasketchewan','GENERAL DELIVERY','WOLLASTON LAKE','Sasketchewan','S0J 3C0'));
        tempDB.push( new FNAddress('James Smith','370','Sasketchewan','PO BOX 1059','MELFORT','Sasketchewan','S0E 1A0'));
        tempDB.push( new FNAddress('Kahkewistahaw','362','Sasketchewan','PO BOX 609','BROADVIEW','Sasketchewan','S0G 0K0'));
        tempDB.push( new FNAddress('Kawacatoose','393','Sasketchewan','PO BOX 640','RAYMORE','Sasketchewan','S0A 3J0'));
        tempDB.push( new FNAddress('Keeseekoose','367','Sasketchewan','PO BOX 1120','KAMSACK','Sasketchewan','S0A 1S0'));
        tempDB.push( new FNAddress('Kinistin Saulteaux Nation','377','Sasketchewan','PO BOX 2590','TISDALE','Sasketchewan','S0E 1T0'));
        tempDB.push( new FNAddress('Lac La Ronge','353','Sasketchewan','PO BOX 480','LA RONGE','Sasketchewan','S0J 1L0'));
        tempDB.push( new FNAddress('Little Black Bear','379','Sasketchewan','PO BOX 40','GOODEVE','Sasketchewan','S0A 1C0'));
        tempDB.push( new FNAddress('Mistawasis Nehiyawak','374','Sasketchewan','PO BOX 250','LEASK','Sasketchewan','S0J 1M0'));
        tempDB.push( new FNAddress('Montreal Lake','354','Sasketchewan','PO BOX 106','MONTREAL LAKE','Sasketchewan','S0J 1Y0'));
        tempDB.push( new FNAddress('Moosomin','342','Sasketchewan','PO BOX 98','COCHIN','Sasketchewan','S0M 0L0'));
        tempDB.push( new FNAddress('Mosquito, Grizzly Bear s Head, Lean Man First Nations','343','Sasketchewan','PO BOX 177','CANDO','Sasketchewan','S0K 0V0'));
        tempDB.push( new FNAddress('Muscowpetung','381','Sasketchewan','PO BOX 1310','FORT QU APPELLE','Sasketchewan','S0G 1S0'));
        tempDB.push( new FNAddress('Muskeg Lake Cree Nation #102','375','Sasketchewan','PO BOX 248','MARCELIN','Sasketchewan','S0J 1R0'));
        tempDB.push( new FNAddress('Muskoday First Nation','371','Sasketchewan','PO BOX 99','MUSKODAY','Sasketchewan','S0J 3H0'));
        tempDB.push( new FNAddress('Muskowekwan','392','Sasketchewan','PO BOX 249','LESTOCK','Sasketchewan','S0A 2G0'));
        tempDB.push( new FNAddress('Nekaneet','380','Sasketchewan','PO BOX 548','MAPLE CREEK','Sasketchewan','S0N 1N0'));
        tempDB.push( new FNAddress('Ocean Man','408','Sasketchewan','PO BOX 157','STOUGHTON','Sasketchewan','S0G 4T0'));
        tempDB.push( new FNAddress('Ochapowace','363','Sasketchewan','PO BOX 550','WHITEWOOD','Sasketchewan','S0G 5C0'));
        tempDB.push( new FNAddress('Okanese','382','Sasketchewan','PO BOX 759','BALCARRES','Sasketchewan','S0G 0C0'));
        tempDB.push( new FNAddress('One Arrow First Nation','373','Sasketchewan','PO BOX 147','BELLEVUE','Sasketchewan','S0K 3Y0'));
        tempDB.push( new FNAddress('Onion Lake Cree Nation','344','Sasketchewan','PO BOX 100','ONION LAKE','Sasketchewan','S0M 2E0'));
        tempDB.push( new FNAddress('Red Earth','356','Sasketchewan','PO BOX 109','RED EARTH','Sasketchewan','S0E 1K0'));
        tempDB.push( new FNAddress('Red Pheasant','346','Sasketchewan','PO BOX 70','CANDO','Sasketchewan','S0K 0V0'));
        tempDB.push( new FNAddress('Saulteaux','347','Sasketchewan','PO BOX 159','COCHIN','Sasketchewan','S0M 0L0'));
        tempDB.push( new FNAddress('Shoal Lake Cree Nation','357','Sasketchewan','PO BOX 51','PAKWAW','Sasketchewan','S0E 1G0'));
        tempDB.push( new FNAddress('Standing Buffalo','386','Sasketchewan','PO BOX 128','FORT QU APPELLE','Sasketchewan','S0G 1S0'));
        tempDB.push( new FNAddress('Star Blanket Cree Nation','387','Sasketchewan','PO BOX 456','BALCARRES','Sasketchewan','S0G 0C0'));
        tempDB.push( new FNAddress('Sturgeon Lake First Nation','360','Sasketchewan','RR 1 SITE 12, PO BOX 5','SHELLBROOK','Sasketchewan','S0J 2E0'));
        tempDB.push( new FNAddress('Sweetgrass','348','Sasketchewan','PO BOX 147','GALLIVAN','Sasketchewan','S0M 0X0'));
        tempDB.push( new FNAddress('The Key First Nation','368','Sasketchewan','PO BOX 70','NORQUAY','Sasketchewan','S0A 2V0'));
        tempDB.push( new FNAddress('Thunderchild First Nation','349','Sasketchewan','PO BOX 600','TURTLEFORD','Sasketchewan','S0M 2Y0'));
        tempDB.push( new FNAddress('Wahpeton Dakota Nation','358','Sasketchewan','PO BOX 128','PRINCE ALBERT','Sasketchewan','S6V 5R4'));
        tempDB.push( new FNAddress('Waterhen Lake','402','Sasketchewan','PO BOX 9','WATERHEN LAKE','Sasketchewan','S0M 3B0'));
        tempDB.push( new FNAddress('White Bear','365','Sasketchewan','PO BOX 700','CARLYLE','Sasketchewan','S0C 0R0'));
        tempDB.push( new FNAddress('Whitecap Dakota First Nation','372','Sasketchewan','182 CHIEF WHITECAP TRAIL','WHITECAP','Sasketchewan','S7K 2L2'));
        tempDB.push( new FNAddress('Witchekan Lake','407','Sasketchewan','PO BOX 879','SPIRITWOOD','Sasketchewan','S0J 2M0'));
        tempDB.push( new FNAddress('Wood Mountain','388','Sasketchewan','PO BOX 1792','ASSINIBOIA','Sasketchewan','S0H 0B0'));
        tempDB.push( new FNAddress('Yellow Quill','376','Sasketchewan','PO BOX 40','YELLOW QUILL','Sasketchewan','S0A 3A0'));
