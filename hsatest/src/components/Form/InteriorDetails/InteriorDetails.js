                ...
                <div class="form-header">
                        <div class="grid-container">
                                <div className="questions grid-child">
                                        ...
                                        <input type="radio" value="Yes" name="q8" /> Yes &emsp;
                                        <input type="radio" value="No" name="q8" /> No &emsp;
                                        </div>
                                        
                                        &emsp;&emsp; 
                                        <div className="ques">8a. Do they work when tested? Co: </div>&emsp;      
                                        <div className="radioOptions">
                                        <input type="radio" value="Yes" name="q8a" />Yes &emsp;
                                        <input type="radio" value="No" name="q8a" /> No &emsp;
                                        </div>      
                                        <p/>
                                        <div>       
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">   
                                        <input type="radio" value="Yes" name="q9" /> Yes &emsp;
                                        <input type="radio" value="No" name="q9" /> No &emsp;
                                        </div>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">   
                                        <input type="radio" value="Yes" name="q10" /> Yes &emsp;
                                        <input type="radio" value="No" name="q10" /> No &emsp;
                                        </div>
                                        ...
                                        <div className="radioOptions">   
                                        <input type="radio" value="Yes" name="q11" /> Yes &emsp;
                                        <input type="radio" value="No" name="q11" /> No &emsp;
                                        </div>
                                        <p/> 
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q12" /> Yes &emsp;
                                                <input type="radio" value="No" name="q12" /> No &emsp;
                                                <input type="radio" value="N/A" name="q12" /> N/A
                                        </div> 
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q13" /> Yes &emsp;
                                                <input type="radio" value="No" name="q13" /> No
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q14" /> Yes &emsp;
                                                <input type="radio" value="No" name="q14" /> No
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q15" /> Yes &emsp;
                                                <input type="radio" value="No" name="q15" /> No
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q16" /> Yes &emsp;
                                                <input type="radio" value="No" name="q16" /> No
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q17" /> Yes &emsp;
                                                <input type="radio" value="No" name="q17" /> No
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q18" /> Yes &emsp;
                                                <input type="radio" value="No" name="q18" /> No &emsp;
                                                <input type="radio" value="N/A" name="q18" /> N/A
                                        </div> 
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q19" /> Yes &emsp;
                                                <input type="radio" value="No" name="q19" /> No &emsp;
                                                <input type="radio" value="N/A" name="q19" /> N/A
                                        </div> 
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">    
                                                <input type="radio" value="Yes" name="q20" /> Yes &emsp;
                                                <input type="radio" value="No" name="q20" /> No &emsp;
                                                <input type="radio" value="N/A" name="q20" /> N/A
                                        </div> 
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">      
                                                <input type="radio" value="Yes" name="q21" /> Yes &emsp;
                                                <input type="radio" value="No" name="q21" /> No &emsp;
                                                <input type="radio" value="N/A" name="q21" /> N/A
                                        </div> 
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions"> 
                                                <input type="radio" value="Yes" name="q22" /> Yes &emsp;
                                                <input type="radio" value="No" name="q22" /> No &emsp;
                                                <input type="radio" value="N/A" name="q22" /> N/A 
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">    
                                                <input type="radio" value="Yes" name="q23" /> Yes &emsp;
                                                <input type="radio" value="No" name="q23" /> No &emsp;
                                                <input type="radio" value="N/A" name="q23" /> N/A 
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">   
                                                <input type="radio" value="Yes" name="q24" /> Yes &emsp;
                                                <input type="radio" value="No" name="q24" /> No &emsp;
                                                <input type="radio" value="N/A" name="q24" /> N/A 
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">
                                                <input type="radio" value="Yes" name="q25" /> Yes &emsp;
                                                <input type="radio" value="No" name="q25" /> No &emsp;
                                                <input type="radio" value="N/A" name="q25" /> N/A 
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">
                                                <input type="radio" value="Yes" name="q26" /> Yes &emsp;
                                                <input type="radio" value="No" name="q26" /> No &emsp;
                                                <input type="radio" value="N/A" name="q26" /> N/A 
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">
                                                <input type="radio" value="Yes" name="q27" /> Yes &emsp;
                                                <input type="radio" value="No" name="q27" /> No &emsp;
                                                <input type="radio" value="N/A" name="q27" /> N/A 
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">
                                                <input type="radio" value="Yes" name="q28" /> Yes &emsp;
                                                <input type="radio" value="No" name="q28" /> No 
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions">
                                                <input type="radio" value="Yes" name="q29" /> Yes &emsp;
                                                <input type="radio" value="No" name="q29" /> No
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
                                ...
                                <div className="questions grid-child">
                                        ...
                                        <div className="radioOptions"> 
                                                <input type="radio" value="Yes" name="q30" /> Yes &emsp;
                                                <input type="radio" value="No" name="q30" /> No
                                        </div>
                                        <p/>       
                                        <div>       
                                                <textarea rows="3" cols="60" placeholder=" Enter Comments.." ></textarea>
