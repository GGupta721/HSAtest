...
class Form extends Component {
    ...
    // };
    // const async function callAPI() {
    //     var myHeaders = new Headers();
    //     myHeaders.append("Content-Type", "application/json");
    //     var raw = JSON.stringify({
    //         UID: this.state.unitNum,
    //         firstname: this.state.firstName,
    //         lastname: this.state.lastName
    //     });
    ...
    //     };
    //     try {
    //         await fetch("https://l83up4h02f.execute-api.ca-central-1.amazonaws.com/dev", requestOptions);
    //     } catch (error) {
                ...
                return(
                    <div>
                        <div className="interior db">
                            ...
                            <InteriorDetails submitHandler = {this.submitHandler} handleChange ={this.handleChange} interiorValues = {interiorValues} nextPage= {this.nextPage} BuildingSafetyChange={this.BuildingSafetyChange} LifeSafetyChange={this.LifeSafetyChange} InjurySafetyChange={this.InjurySafetyChange} HealthSafetyChange={this.HealthSafetyChange} prevPage={this.prevPage}/>
                        </div>
                    </div>
